...
int main(void) {
    ...
    while(1) {
        ...
        //show
        write_data(0x04, 0b00011000); _delay_ms(70);
        write_data(0x05, 0b00011000); _delay_ms(70);
        write_data(0x03, 0b00100100); _delay_ms(70);
        write_data(0x06, 0b00100100); _delay_ms(70);
        write_data(0x02, 0b11000011); _delay_ms(70);
        write_data(0x07, 0b11000011); _delay_ms(70);
        write_data(0x01, 0b11000011); _delay_ms(70);
        write_data(0x08, 0b11000011);
        _delay_ms(250);        
    }
    return(0);
}
